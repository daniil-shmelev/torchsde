...
def main():
    ...
    methods = ('euler_heun', 'heun', 'midpoint', 'reversible_heun', 'ees25', 'ees27', 'milstein', 'milstein', 'log_ode')
    options = (None, None, None, None, None, None, None, dict(grad_free=True), None)
    labels = ('euler-heun', 'heun', 'midpoint', 'reversible_heun', 'ees25', 'ees27', 'milstein', 'grad-free milstein', 'log_ode')
